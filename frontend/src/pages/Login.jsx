...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-50 to-cyan-50 flex-col justify-between p-12">
        <Logo />
        ...
        <div>
          ...
          <p className="text-gray-500 text-lg">
            Track every cent. Understand your habits.<br />Build a better financial future.
          </p>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 py-12 bg-white">
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <span className="text-xs text-emerald-500 cursor-pointer hover:text-emerald-600">
                  Forgot password?
                </span>
              </div>
              <input
          ...
          <p className="text-center text-sm text-gray-400 mt-6">
            ...
            <Link to="/register" className="text-emerald-500 font-medium hover:text-emerald-600">
              Sign up
            </Link>
          </p>
        </div>
